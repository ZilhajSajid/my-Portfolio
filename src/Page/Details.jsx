...
const Details = () => {
  ...
  const { photo, photo1, photo2, Details, livelink, github, name, keyword } =
    pro;

  return (
    <div className="w-full h-[1200px] md:h-[1200px]  lg:h-[1100px]  mx-auto relative">
      <img className=" w-full h-full" src={bg} alt="" />
      <div className="bg-[#00000092] absolute z-0 top-[0%] md:top-[0%] lg:top-[0%] w-full h-full"></div>
            ...
            <Slide direction="right">
              <div className="w-full p-5">
                <div className="w-full mx-auto mt-5 ml-0  space-y-5">
                  ...
                  <p className="bg-[#000000c8] p-2 ml-[-5px] rounded-2xl">
                    {Details}
                  </p>
                  <div className="space-x-4">
                    <Link
                      className="p-3 bg-[#0fc2c7] hover:bg-[#0d639f] rounded-lg font-bold"
                      to={livelink}
                    >
                      Live Link
                    </Link>
                  ...
                  <div className="flex flex-wrap gap-5">
                    {keyword.map((k) => (
                      <span className="p-3 bg-purple-800 rounded-lg">{k}</span>
                    ))}
                  </div>
