      ...
      <div className="bg-gradient-to-r from-sky-500  via-[#072531] to-[#0fc2c7] p-[3px] rounded-2xl group transition-transform duration-300 hover:-translate-y-5">
        ...
        <div className=" bg-[#06131b] w-full shadow-sm rounded-2xl">
          <div className="rounded-2xl">
            <img
              className="rounded-2xl  h-[200px] md:h-[200px] lg:h-[300px]"
              src={photo}
              alt="Shoes"
            />
          </div>
          <div className="card-body">
            ...
            <div className="mt-2 mb-4">
              <div className="flex flex-wrap gap-2 max-h-[100px] overflow-x-auto">
                {keyword.map((k, index) => (
                  <span
                    key={index}
                    className="text-sm border-2 border-gray-800 p-2 rounded-2xl"
                  >
                    {k}
                  </span>
                ))}
