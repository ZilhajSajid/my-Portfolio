...
const Banner = () => {
  return (
    <div className="relative">
      <img
        className="z-0 w-full h-[720px] md:h-[450px] lg:h-[600px]"
        src={bg}
        alt=""
      />
      <div className="bg-[#00000071] absolute top-[12%] md:top-[18%] lg:top-[20%] w-full h-[630px] md:h-[370px] lg:h-[500px] "></div>
        ...
        <div className="p-5 md:p-5 lg:py-[100px] lg:pl-[70px] space-y-4">
          <Slide direction="left">
            ...
            <p className="md:font-bold">
              This is my portfolio with a collection of my work, achievements,
              and skills that highlights my abilities and professional growth.
            </p>
          </Slide>
        </div>
        <div className="">
          <div className="w-full h-full flex items-center ">
            <div className="w-[200px] md:w-[200px] lg:w-[300px] mx-auto">
              <Slide direction="right">
                <img
                  src={pro}
                  className="w-[200px] bg-[#06131b] md:w-[200px] lg:w-[300px] mx-auto rounded-2xl border border-gray-200"
                  alt=""
                />
              </Slide>
            </div>
